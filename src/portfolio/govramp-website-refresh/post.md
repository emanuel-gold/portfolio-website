...
{% postImage "Sitemap.png", "A clear, new sitemap for GovRAMP.org", { caption: "A clear, new sitemap for GovRAMP.org" } %}
...
{% postImage "Register.png", "GovRAMP registration page design" %}

{% postImage "Home-CTAS.png", "Call-to-action blocks on the GovRAMP homepage" %}

{% postImage "Menus-1.png", "Navigation menus on the refreshed GovRAMP website" %}

### Out with the old…

{% postImage "Home.png", "Legacy GovRAMP homepage" %}

### And in with the new:

{% postImage "Home-new.png", "Updated GovRAMP homepage" %}
